...
export const contactVenueTemplate = ({ performer, collaborators, emailText }: {
  ...
  <p>${emailText}</p> 
    ...
    <p>You can check my past booking history on my here <a href="https://app.tapped.ai/u/${username}">https://app.tapped.ai/u/${username}</a></p>
  ...
  const text = `
    ...
    You can check my past booking history on my here https://app.tapped.ai/u/${username}
