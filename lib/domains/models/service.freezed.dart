...
mixin _$Service {
  ...
  RateType get rateType => throw _privateConstructorUsedError;
...
class _$ServiceImpl implements _Service {
  ...
  @override
  String toString() {
    return 'Service(id: $id, userId: $userId, title: $title, description: $description, rate: $rate, rateType: $rateType, count: $count, deleted: $deleted)';
  }
...
abstract class _Service implements Service {
  const factory _Service(
      ...
      final RateType rateType,
      final int count,
      final bool deleted}) = _$ServiceImpl;
