...
enum Genre {
  ...
  @JsonValue('chanson')
  chanson,
  @JsonValue('childrensMusic')
  childrensMusic,
  @JsonValue('christmas')
  christmas,
  @JsonValue('classical')
  classical,
  @JsonValue('classicalCrossover')
  classicalCrossover,
  @JsonValue('comedy')
  comedy,
  @JsonValue('country')
  ...
  @JsonValue('darkwave')
  darkwave,
  @JsonValue('deathIndustrial')
  deathIndustrial,
  @JsonValue('dembow')
  dembow,
  @JsonValue('driftPhonk')
  driftPhonk,
  @JsonValue('drone')
  drone,
  @JsonValue('dungeonSynth')
  dungeonSynth,
  @JsonValue('easyListening')
  easyListening,
  @JsonValue('emo')
  emo,
  @JsonValue('epicCollage')
  epicCollage,
  @JsonValue('etherealWave')
  etherealWave,
  @JsonValue('exotica')
  exotica,
  @JsonValue('experimental')
  experimental,
  @JsonValue('fieldRecordings')
  fieldRecordings,
  @JsonValue('flamenco')
  flamenco,
  @JsonValue('flamencoPop')
  flamencoPop,
  @JsonValue('folk')
  folk,
  @JsonValue('forró')
  ...
  @JsonValue('klezmer')
  klezmer,
  @JsonValue('latinAlternative')
  latinAlternative,
  @JsonValue('liquidDrumAndBass')
  liquidDrumAndBass,
  @JsonValue('mambo')
  mambo,
  @JsonValue('mandeMusic')
  mandeMusic,
  @JsonValue('maracatu')
  maracatu,
  @JsonValue('mariachi')
  ...
  @JsonValue('mashup')
  mashup,
  @JsonValue('minimalSynth')
  minimalSynth,
  @JsonValue('modaDeViola')
  modaDeViola,
  @JsonValue('mpb')
  mpb,
  @JsonValue('musicalParody')
  musicalParody,
  @JsonValue('musiqueConcrète')
  musiqueConcrete,
  @JsonValue('neoMedievalFolk')
  neoMedievalFolk,
  @JsonValue('neoclassicalDarkwave')
  ...
  @JsonValue('noisePop')
  noisePop,
  @JsonValue('noisegrind')
  noisegrind,
  @JsonValue('nwobhm')
  nwobhm,
  @JsonValue('pianoRock')
  pianoRock,
  @JsonValue('plunderphonics')
  plunderphonics,
  @JsonValue('polka')
  polka,
  @JsonValue('postHardcore')
  postHardcore,
  @JsonValue('postMinimalism')
  postMinimalism,
  @JsonValue('postPunk')
  postPunk,
  @JsonValue('powerElectronics')
  powerElectronics,
  @JsonValue('powerPop')
  powerPop,
  @JsonValue('progressivePop')
  progressivePop,
  ...
  @JsonValue('regional')
  regional,
  @JsonValue('rockAndRoll')
  rockAndRoll,
  @JsonValue('rockabilly')
  rockabilly,
  @JsonValue('salsa')
  salsa,
  @JsonValue('samba')
  samba,
  @JsonValue('sampledelia')
  sampledelia,
  @JsonValue('seaShanties')
  seaShanties,
  @JsonValue('sertanejo')
  sertanejo,
  @JsonValue('sertanejoDeRaiz')
  sertanejoDeRaiz,
  @JsonValue('sertanejoUniversitário')
  sertanejoUniversitario,
  @JsonValue('showTunes')
  showTunes,
  @JsonValue('sierreño')
  sierreno,
  @JsonValue('singerSongwriter')
  singerSongwriter,
  @JsonValue('ska')
  ska,
  @JsonValue('spokenWord')
  spokenWord,
  @JsonValue('standards')
  standards,
  @JsonValue('surfPop')
  ...
  @JsonValue('tango')
  tango,
  @JsonValue('tishoumaren')
  tishoumaren,
  @JsonValue('totalism')
  totalism,
  @JsonValue('tweePop')
  tweePop,
  @JsonValue('vanguardaPaulista')
  vanguardaPaulista,
  @JsonValue('vapor')
  vapor,
  @JsonValue('xote')
...
Option<Genre> genreFromString(String genre) {
  ...
  return Option.of(Genre.values[index]);
}

List<Genre> fromStrings(List<String> strings) => strings
    .map(genreFromString)
    .whereType<Some<Genre>>()
    .map((e) => e.value)
    .toList();
