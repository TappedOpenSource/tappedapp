...
import 'package:intheloopapp/ui/profile/components/performer_category_details.dart';
                ...
                onTap: () {
                  showModalBottomSheet<void>(
                    ...
                    builder: (BuildContext context) {
                      return PerformerCategoryDetails(
                        category: value,
                      );
                    },
                  );
                          ...
                          axis: GaugeAxis(
                            ...
                            segments: [
                              for (final categoryValue in categoryValues)
                                GaugeSegment(
                                  from: categoryValue.performerScoreRange.$1
                                      .toDouble(),
                                  to: categoryValue.performerScoreRange.$2
                                      .toDouble(),
